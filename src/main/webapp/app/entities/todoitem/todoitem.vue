        ...
        <div class="table-responsive" v-if="todoitems && todoitems.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th v-on:click="changeOrder('user.login')"><span>User</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'user.login'"></jhi-sort-indicator></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="todoitem in todoitems"
                    ...
                    <td>{{todoitem.task}}</td>
                    <td>
                        {{todoitem.user ? todoitem.user.login : ''}}
                    </td>
                    <td class="text-right">
                        <div class="btn-group">
