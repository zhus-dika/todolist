...
import com.todolist.webapp.config.audit.AuditEventConverter;
import com.todolist.webapp.domain.PersistentAuditEvent;
...
import static com.todolist.webapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
